    ...
    public class NurseInstructionsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var instruction = await _context.NurseInstructions
                .Include(i => i.Patient) // Make sure Patient navigation property is included
                .Include(i => i.Users)    // Include any related Users if necessary
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var instruction = await _context.NurseInstructions
                .Include(i => i.Patient) // Assuming Patient is a navigation property
                .FirstOrDefaultAsync(i => i.InstructionId == id);
            ...
            var instructionViewModel = new InstructionViewModel
            {
                ...
                PatientID = instruction.PatientID, // Make sure PatientID is mapped
            ...
            return View(instructionViewModel); // Ensure you return the ViewModel here
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> NurseEdit(int id, InstructionViewModel instructionViewModel)
        {
            if (id != instructionViewModel.InstructionId)
            {
                return NotFound();
